...
class GAT(nn.Module):
    ...
    def __init__(self,
        ...
        last_activation = self.ACT_MAP[self.activation] if encoding else None
        ...
        if num_layers == 1:
            ...
            self.gat_layers.append(GATConv(
                ...
                feat_drop, attn_drop, negative_slope, residual, self.ACT_MAP[self.activation], norm=norm, concat_out=concat_out))
            # hidden layers
